...
btnReset = Button(medicinePan, text="Clear", command=clearMeds, 
                      bg="#497687", fg="#ffffff")
btnReset.config(font=("Microsoft JhengHei", 11),cursor="hand2")
btnReset.place(relx=0.54, rely=0.95, anchor=CENTER)
...
btnNew = Button(medicinePan, text="Delete", command=deleteMeds, 
                      bg="#497687", fg="#ffffff")
btnNew.config(font=("Microsoft JhengHei", 11),cursor="hand2")
btnNew.place(relx=0.66, rely=0.95, anchor=CENTER)
...
meds_tv.heading("3", text="Product Neme")
